...
<body>
    ...
    <main>
        ...
        <div id="SD">
            <img src="american.jpg" alt="peruu">
                 <?php
            $sql = "SELECT * FROM rasy WHERE id = 6";
            ...
            ?>
             <?php
            $sql = "SELECT * FROM swinki WHERE id = 1";
            $result = mysqli_query($conn, $sql);
            while($row = mysqli_fetch_assoc($result)){
            ...
            ?>
            <?php
            $sql = "SELECT * FROM swinki WHERE id = 2";
            $result = mysqli_query($conn, $sql);
            while($row = mysqli_fetch_assoc($result)){
            ...
            ?>
            <?php
            $sql = "SELECT * FROM swinki WHERE id = 3";
            $result = mysqli_query($conn, $sql);
            while($row = mysqli_fetch_assoc($result)){
